...
createCRUD('/employees', 'employeeDatabase.json', 'employees', [
    ...
    ['present_address', check('present_address').exists().withMessage('present_address must be provided').isLength({min : 1, max : 20}).withMessage('present_address must be between 1 to 20 chars')],
    ['permanent_address', check('permanent_address').exists().withMessage('permanent_address must be provided').isLength({min : 1, max : 20}).withMessage('permanent_address must be between 1 to 20 chars')],
    ['academic_achievement', check('academic_achievement').exists().withMessage('academic_achievement must be provided').isLength({min : 1, max : 20}).withMessage('academic_achievement must be between 1 to 20 chars')],
    ['languages_skills', check('languages_skills').exists().withMessage('languages_skills must be provided').isLength({min : 1, max : 20}).withMessage('languages_skills must be between 1 to 20 chars')],
